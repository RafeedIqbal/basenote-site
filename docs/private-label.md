...
- `/case-studies` uses the same project list through the `caseStudies` export, displaying each project's first image, name, headline and complete story. Project slugs also provide direct section links such as `/case-studies#firmino`.
